...
const T = {
    ar: { dir: 'rtl', font: "'Tajawal', 'Inter', system-ui, sans-serif",
        ...
        f3t: 'AI يفهم السياق', f3d: 'يفهم العامية والجنس من تصريف الفعل، ويتذكر محادثتك داخل القيم. مو ترجمة حرفية.',
    ...
    en: { dir: 'ltr', font: "'Inter', 'Tajawal', system-ui, sans-serif",
        ...
        f3t: 'Context-Aware AI', f3d: 'Understands slang, detects gender, and remembers your in-game conversation.',
    ...
    tr: { dir: 'ltr', font: "'Inter', system-ui, sans-serif",
        ...
        f3t: 'Bağlam Farkında AI', f3d: 'Argo anlar, cinsiyet algılar ve oyun içi konuşmanı hatırlar.',
    ...
    es: { dir: 'ltr', font: "'Inter', system-ui, sans-serif",
        ...
        f3t: 'IA Contextual', f3d: 'Entiende jerga, detecta género y recuerda tu conversación en la partida.',
    ...
    fr: { dir: 'ltr', font: "'Inter', system-ui, sans-serif",
        ...
        f3t: 'IA Contextuelle', f3d: 'Comprend l\'argot, détecte le genre et suit ta conversation en jeu.',
    ...
    pt: { dir: 'ltr', font: "'Inter', system-ui, sans-serif",
        ...
        f3t: 'IA Contextual', f3d: 'Entende gírias, detecta gênero e acompanha sua conversa na partida.',
    ...
    ru: { dir: 'ltr', font: "'Inter', system-ui, sans-serif",
        ...
        f3t: 'ИИ с Контекстом', f3d: 'Понимает сленг, определяет пол и помнит ход разговора в игре.',
    ...
    de: { dir: 'ltr', font: "'Inter', system-ui, sans-serif",
        ...
        f3t: 'Kontext-KI', f3d: 'Versteht Slang, erkennt Geschlecht und merkt sich dein Gespräch im Spiel.',
    ...
    ko: { dir: 'ltr', font: "'Inter', system-ui, sans-serif",
        ...
        f3t: '맥락 이해 AI', f3d: '속어 이해, 성별 감지, 게임 중 대화 흐름까지 기억.',
    ...
    ja: { dir: 'ltr', font: "'Inter', system-ui, sans-serif",
        ...
        f3t: 'コンテキスト認識AI', f3d: 'スラング理解、性別検出、ゲーム中の会話も記憶。',
    ...
    zh: { dir: 'ltr', font: "'Inter', system-ui, sans-serif",
        ...
        f3t: '上下文感知AI', f3d: '理解俚语，检测性别，还能记住游戏中的对话。',
    ...
    hi: { dir: 'ltr', font: "'Inter', system-ui, sans-serif",
        ...
        f3t: 'कॉन्टेक्स्ट-अवेयर AI', f3d: 'स्लैंग समझता है, जेंडर डिटेक्ट करता है, और गेम के दौरान बातचीत याद रखता है।',
